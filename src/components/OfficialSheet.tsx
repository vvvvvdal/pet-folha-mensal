...
export function OfficialSheet({
  ...
  return (
    ...
    >
      ...
      {/* Título */}
      <h1 className="text-center text-[16pt] md:text-[17pt] font-bold text-black my-2 tracking-tight">
      ...
      <table className="official-table w-full border-collapse border-[1.5px] border-black text-[9pt] md:text-[9.5pt] text-black mb-2">
        <thead>
          <tr className="bg-white font-bold">
            <th className="border border-black p-1.5 text-center w-[11%]">Data</th>
            <th className="border border-black p-1.5 text-center w-[12%]">Horário de Chegada</th>
            <th className="border border-black p-1.5 text-center w-[12%]">Horário de Saída</th>
            <th className="border border-black p-1.5 text-center w-[47%]">Atividade</th>
            <th className="border border-black p-1.5 text-center w-[18%]">Assinatura</th>
          </tr>
        </thead>
        <tbody>
          {!isBlankTemplate &&
